...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng fau = new LatLng(latitude, longitude);
        map.addMarker(new MarkerOptions().position(fau).title("Marker in FAU"));
        map.moveCamera(CameraUpdateFactory.newLatLng(fau));
    }
